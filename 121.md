...
```json
{
   ...
   "tags": [
      ...
      ["p": "june", “<recommended relay URL>”, “<latest stringified Kind 0 event posted by bob>”],
      ["p": "tim", “<recommended relay URL>”, “<latest stringified Kind 0 event posted by bob>”],
      ["p": "jane", “<recommended relay URL>”, “<latest stringified Kind 0 event posted by bob>”]
   ]
   …
}```
